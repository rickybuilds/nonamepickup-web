export const LIVE_CONFIG = Object.freeze({
  ...
  extrasArchive: "./runtime/tf15client-extras.pk3?v=20260826n",
  valveExtrasArchive: "./runtime/valve-extras.pk3?v=20260826n",
  relayPath: "/api/live/relay",
  runtimeLibraries: Object.freeze({
    xash: "./runtime/xash.wasm?v=20260826n",
    filesystem: "./runtime/filesystem_stdio.wasm?v=20260826n",
    renderer: "./runtime/libref_webgl2.wasm?v=20260826n",
    menu: "./runtime/cl_dlls/menu_emscripten_wasm32.wasm?v=20260826n",
    client: "./runtime/cl_dlls/client_emscripten_wasm32.wasm?v=20260826n",
    server: null
  }),
