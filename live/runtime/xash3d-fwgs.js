// .live-build/runtime-package/node_modules/.pnpm/xash3d-fwgs@1.2.2/node_modules/xash3d-fwgs/dist/constants.js
...
// .live-build/runtime-package/node_modules/.pnpm/xash3d-fwgs@1.2.2/node_modules/xash3d-fwgs/dist/generated/xash.js
var Xash3D = (() => {
...
`;
    ...
    var _emscripten_glDrawRangeElements = (mode, start2, end, count, type, indices) => {
...
// .live-build/runtime-package/node_modules/.pnpm/xash3d-fwgs@1.2.2/node_modules/xash3d-fwgs/dist/xash3d.js
function ErrNoLocation(em) {
  const ptr2 = em?.Module.ccall("getErrnoLocation", "number", [], []);
  if (!ptr2)
    return 0;
  return em.getValue(ptr2, "i32");
}
var Xash3D2 = class {
  ...
  async runEm() {
    ...
    const dynamicLibraries2 = [
      ...
      ...this.opts.libraries?.server === null ? [] : [DEFAULT_SERVER_LIBRARY],
...
// .live-build/runtime-package/node_modules/.pnpm/xash3d-fwgs@1.2.2/node_modules/xash3d-fwgs/dist/utils/rb.js
var RollingBuffer = class {
  ...
  toArray() {
    ...
    for (let i2 = 0; i2 < this.size(); ++i2) {
      const idx = (this.tail + i2) % this.opts.maxSize;
      res[i2] = this.buffer[idx];
    }
    return res;
  }
};

// .live-build/runtime-package/node_modules/.pnpm/xash3d-fwgs@1.2.2/node_modules/xash3d-fwgs/dist/net/net.js
var Net = class {
  ...
  recvfrom(fd, bufPtr, bufLen, flags2, sockaddrPtr, socklenPtr) {
  ...
  sendto(fd, bufPtr, bufLen, flags2, sockaddrPtr, socklenPtr) {
    const em = this.em;
    const heapU8 = em.HEAPU8;
  ...
  sendtoBatch(fd, bufsPtr, lensPtr, count, flags2, sockaddrPtr, socklenPtr) {
    const em = this.em;
    ...
    for (let i2 = 0; i2 < count; ++i2) {
      const size = heap32[(lensPtr >> 2) + i2];
      const packetPtr = heap32[(bufsPtr >> 2) + i2];
